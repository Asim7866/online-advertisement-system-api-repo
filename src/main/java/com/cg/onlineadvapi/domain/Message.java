...
public class Message {
	 ...
	 */
	@NotNull(message = "Please Enter a Valid Advertise Id")
	...
	public String toString() {
		return "Message with values : {messageId=" + messageId + ", advertiseId=" + adv_id + "" + ", receiverId="
				+ receiverId + ", senderId=" + senderId + ", " + "message=" + message + ", send_At=" + send_At + ",}";
	}
