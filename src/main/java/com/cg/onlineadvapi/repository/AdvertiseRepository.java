...
public interface AdvertiseRepository extends JpaRepository<Advertise, Integer> {
	...
	/**
	 * This query is used by admin and user module both to get all 2 status
	 * advertise
	 * 
	...
	/**
	 * This query is used by admin and user module both to get all 1 status
	 * advertise
	 * 
	...
	/**
	 * This query is used by admin and user module both to get all 4 status
	 * advertise
	 * 
	...
	/**
	 * This query is used by admin and user module both to get all 3 status
	 * advertise
	 * 
