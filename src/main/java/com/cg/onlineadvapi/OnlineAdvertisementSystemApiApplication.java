...
public class OnlineAdvertisementSystemApiApplication {
	...
	public static void main(String[] args) {
		/**
		 * It bootstraps a Spring Application as a Stand-Alone Application. It creates
		 * an appropriate ApplicationContext instance and load beans. It also runs
		 * embedded Tomcat server in Spring Web Application.
		 */
