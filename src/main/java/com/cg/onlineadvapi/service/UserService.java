...
public interface UserService {
	/**
	 * This deleteUser method will delete existing user data from database using
	 * User ID
	 * 
	 ...
	 * 
	 * @param user
	 * @return this function will return saved user otherwise exception if user
	 *         already exist
	 */
	...
	// User Login
	/**
	 * This authenticateUser will authenticate the User and Send authenticated User
	 * if user is available in database
	 * 
