...
/**
 * This AdvertiseService is responsible for all the business logic on Advertise
 * operations
 * 
 * @author shivamt
 *
...
public interface AdvertiseService {
	/**
	 * This viewAdvertisementByUser method will return list of all Advertisement
	...
	/**
	 * This deleteAdvertise method will delete the required advertisement from the
	 * database.
	 * 
	...
	/**
	 * This method is used to delete advertise by Id manage by admin module Here
	 * admin can delete any advertise present in table
	 * 
	 * @param advertiseId
	 */
	...
	/**
	 * This method is used to delete advertise by Id manage by user module Here user
	 * can delete only advertise posted by him/her whose status is OPEN
	 * 
	 * @param advertiseId
	 */
	...
	/**
	 * This method is used to get all advertise present in table manage by admin
	 * module
	 * 
	...
	/**
	 * This method is used to search all accepted advertise by text manage by user
	 * module
	 * 
	 * @param advertiseTitle
	 * @return all advertise that matches the advertise title and whose status is
	 *         OPEN
	 */
	public List<Advertise> findAllOPENAdvertise(String advertiseTitle);

	/**
	 * This method is used to accept/reject/close advertise created/posted by user
	 * manage by admin module
	 * 
	 * @param advertise
	 */
	...
	/**
	 * This method is used to get all accepted advertise in table manage by admin
	 * and user module
	 * 
	...
	/**
	 * This method is used to get all close advertise in table manage by admin
	 * module
	 * 
	...
	/**
	 * This method is used to get all reject advertise in table manage by admin
	 * module
	 * 
	 ...
	 * 
	 * @param advertiseId
	 * @return specific advertise by id only if it is present in database and status
	 *         is OPEN
	 */
